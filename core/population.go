...
var streetTrades = []struct{ role, place string }{
	...
	{"Receiving attendant", "mortuary"}, {"Mortuary technician", "mortuary"}, {"Ambulance driver", "mortuary"},
	{"Groundskeeper", "cemetery"}, {"Gravedigger", "cemetery"}, {"Cemetery clerk", "cemetery"},
	{"Furnace attendant", "crematorium"}, {"Memorial clerk", "crematorium"}, {"Furnace engineer", "crematorium"},
	{"Undertaker", "chapel"}, {"Embalmer", "chapel"}, {"Hearse driver", "chapel"},
	{"Cutter", "tailor"}, {"Finisher", "tailor"}, {"Fitting clerk", "tailor"},
	{"Caretaker", "riverside"}, {"Porter", "riverside"},
}
