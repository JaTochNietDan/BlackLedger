...
type World struct {
	CrewOrders             []CrewOrder                      `json:"crew_orders"`
	...
	DeathServiceReceipts   []DeathServiceReceipt            `json:"death_service_receipts"`
