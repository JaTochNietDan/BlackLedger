...
func (w *World) LeaveService() error {
	...
	if f != nil {
		...
		w.Log("You are your own man again", fmt.Sprintf("%s does not keep people who leave in their good books. Their standing with you is %+d.", f.Name, f.Goodwill), "politics")
