...
case "$city_scenario" in city3d-rain|city3d|city3d-night|city3d-blast|city3d-traffic|city3d-junction|city3d-walk|killing|arrest|gunfight|gunfight-killing) ;; *) echo 'Choose city3d-rain, city3d, city3d-night, city3d-blast, city3d-traffic, city3d-junction, city3d-walk, killing, arrest, gunfight, or gunfight-killing.' >&2; exit 2;; esac
mkdir -p .runtime
