...
case "$city_scenario" in city3d|city3d-night|city3d-blast|city3d-traffic|city3d-junction|city3d-walk) ;; *) echo 'Choose city3d, city3d-night, city3d-blast, city3d-traffic, city3d-junction, or city3d-walk.' >&2; exit 2;; esac
mkdir -p .runtime
