...
for(const [name,x,y,height] of [['interior-flat',-1.25,2.65,.78],['interior-lodging-room',-.67,2.48,.77]])test(`${name} drawer has a real tray that opens out of its case`,async()=>{
