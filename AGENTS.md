...
- The visual agent works on `codex/visual-handoff` in `mafia-game-visuals`. Read `docs/VISUAL_HANDOFF.md` and use its preview/acceptance instructions. Rendering, assets, cosmetic animation and UI skin belong there.
