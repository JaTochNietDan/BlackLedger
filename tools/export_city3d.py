...
def precinct_interior():
    from precinct_interior import build
    build(box,cylinder,material)


if __name__ == '__main__' and '--only=interior-precinct' in __import__('sys').argv:
    clear();precinct_interior()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-precinct']=export('interior-precinct')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)
...
if __name__ == '__main__' and '--only=interior-tailor' in __import__('sys').argv:
    clear();tailor_interior()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-tailor']=export('interior-tailor')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)
...
if __name__ == '__main__' and '--only=interior-docks' in __import__('sys').argv:
    clear();docks_interior()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-docks']=export('interior-docks')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)
...
if __name__ == '__main__' and '--only=interior-herald' in __import__('sys').argv:
    clear();herald_interior()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-herald']=export('interior-herald')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)
...
if __name__ == '__main__' and '--only=interior-restaurant' in __import__('sys').argv:
    clear();restaurant_interior()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-restaurant']=export('interior-restaurant')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)
...
if __name__ == '__main__' and '--only=interior-garage' in __import__('sys').argv:
    clear();garage_interior()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-garage']=export('interior-garage')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)


def butcher_interior():
    from butcher_interior import build
    build(box,cylinder,material)


if __name__ == '__main__' and '--only=interior-butcher' in __import__('sys').argv:
    clear();butcher_interior()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-butcher']=export('interior-butcher')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)


def private_flat():
    from private_flat import build
    build(box,cylinder,material)


if __name__ == '__main__' and '--only=interior-flat' in __import__('sys').argv:
    clear();private_flat()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-flat']=export('interior-flat')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)


def ashbury_interior():
    from ashbury_interior import build
    build(box,cylinder,material)


if __name__ == '__main__' and '--only=interior-ashbury' in __import__('sys').argv:
    clear();ashbury_interior()
    manifest_path=os.path.join(OUT,'manifest.json')
    with open(manifest_path) as f: selected_manifest=json.load(f)
    selected_manifest['interior-ashbury']=export('interior-ashbury')
    with open(manifest_path,'w') as f:json.dump(selected_manifest,f,indent=2)
    raise SystemExit(0)
...
clear();ashbury_interior();manifest['interior-ashbury']=export('interior-ashbury')
