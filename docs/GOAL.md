...
Current objective source: `/Users/jatochnietdan/.codex/attachments/7c9e06f6-fd97-41d6-a946-eee7fde6c804/goal-objective.md` (read September 13; supersedes the earlier 35be00d7 objective).

The expanded scope also requires much richer gambling tables and slot-machine presentation, occupants and animations; consistent styling across every menu; debug access to every assassination variant; explosion preambles showing the planter leaving; new authoritative molotov and building drive-by actions with visible damage and escape; and attacks against the player during street travel. Also stage interior occupants at chairs and counters, render cause-specific player deaths, track and display personal/family backstories and interactions, and illustrate moonshine, untaxed cigarettes and crated arms. These additions remain outstanding and do not replace earlier requirements.
