...
Current objective source: `/Users/jatochnietdan/.codex/attachments/9048dc13-3c42-4832-8cd8-3a8e5594977b/goal-objective.md` (read September 13; supersedes the earlier 35be00d7 objective).

The expanded scope also requires much richer gambling tables and slot-machine presentation, occupants and animations; consistent styling across every menu; debug access to every assassination variant; explosion preambles showing the planter leaving; new authoritative molotov and building drive-by actions with visible damage and escape; and attacks against the player during street travel. These additions remain outstanding and do not replace earlier requirements.
