...
var ventures = []string{
	...
	"trip:rockridge", "trip:kingsport", "trip:halloway", "charge", "plant", "sitdown", "retain:commissioner", "retain:mayor", "rob:crew", "sabotage:crew", "armoury", "stock_arms", "buy:arms", "sell:arms",
}
