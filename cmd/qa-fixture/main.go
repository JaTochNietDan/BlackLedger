	...
	err = s.Change(func(w *core.World) error {
		if scenario == "fatal-charge" {
			...
			for seed := uint32(1); seed <= 128; seed++ {
				...
				if !probe.Player.Alive {
					*w = *setup(seed)
					return nil
				}
			}
			return fmt.Errorf("no fatal charge seed found")
		}
		...
		if scenario == "city3d-rain" || scenario == "city3d-walk" || scenario == "city3d-junction" || scenario == "city3d-traffic" || scenario == "city3d" || scenario == "city3d-night" || scenario == "city3d-blast" {
