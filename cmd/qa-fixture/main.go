...
func main() {
	...
	err = s.Change(func(w *core.World) error {
		...
		if scenario == "butcher" || scenario == "garage-interior" || scenario == "restaurant-interior" || scenario == "exchange-interior" {
