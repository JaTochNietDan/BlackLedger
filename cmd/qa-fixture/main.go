...
func main() {
	...
	err = s.Change(func(w *core.World) error {
		...
		if scenario == "chapel-interior" || scenario == "herald-interior" || scenario == "poolhall-interior" || scenario == "tailor-interior" || scenario == "pawn-interior" || scenario == "riverside-interior" || scenario == "butcher" || scenario == "garage-interior" || scenario == "restaurant-interior" || scenario == "exchange-interior" || scenario == "precinct-interior" {
