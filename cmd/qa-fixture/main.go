...
func main() {
	...
	err = s.Change(func(w *core.World) error {
		...
		if scenario == "home-strike" || scenario == "estate-strike" {
			address := "mercercourt"
