...
export function CrewOrdersPanel({world,busy,act}:{world:Snapshot;busy:boolean;act:(c:Command)=>unknown}) {
 ...
 const active=orders.filter(o=>['outbound','working','returning'].includes(o.stage));
 const completed=orders.filter(o=>!['outbound','working','returning'].includes(o.stage));
