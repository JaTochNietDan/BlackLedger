...
export class InteriorArrival {
 ...
 constructor(private actor:THREE.Group,private place:InteriorPlace){
  ...
  this.start=place==='pawn'?new THREE.Vector3(0,.03,4.15):place==='lodging'?new THREE.Vector3(-2.45,.03,2.45):place==='garage'?new THREE.Vector3(-3,.03,5.02):place==='butcher'?new THREE.Vector3(2.7,.03,4.12):place==='flat'?new THREE.Vector3(0,.03,3.3):place==='estate'?new THREE.Vector3(0,.03,4.3):place==='bar'?new THREE.Vector3(5.25,.03,-.7):(place==='room'||place==='laundry')?new THREE.Vector3(0,.03,3.6):new THREE.Vector3(0,.03,4.6);
