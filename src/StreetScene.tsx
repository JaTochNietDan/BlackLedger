...
interface Props {sequence:VisualCue|null;properties:{id:string;condition:number}[];selected:string;minute:number;position:string;journey:Journey|null;onSelect:(id:string)=>void}
/** Isolated presentation adapter. Only whitelisted inspection messages cross this boundary. */
export function StreetScene({properties,selected,minute,position,journey,sequence,onSelect}:Props){
