...
export function Interior({
  ...
  return (
    <div className="interior-stage">
      ...
      {place.id === 'bar' || place.id === 'mercercourt' || place.id === 'room' ? <Interior3D key={place.id} place={place.id} player={player} motion={motion} people={onFloor} picked={picked} onPick={id=>setPicked(id===picked?'':id)} minute={minute}/> : <div
