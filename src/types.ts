...
export interface Snapshot {
	apartment_market?: {id:string;building:string;number:number;address:string;owned:boolean;home:boolean;available:boolean;owner:string;resident:string;asking:number;offer:number;daily_rent:number}[];
