...
export interface Snapshot {
  ...
  crew_orders?: {id:string;life:number;actor:string;name:string;kind:string;target:string;place:string;base:string;stage:string;due:number;reserved:number;charges?:number;recall:boolean;result:string}[];
